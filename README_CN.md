...
- 多格式输出
    ...
    - 如需 PDF 格式，请点击 HTML 页面右上角的 “下载 PDF” 图标。
       ...
       <img src="docs/_static/download-pdf-cn.png" alt="下载 PDF" width="400">

- 按芯片系列查看
    - 可通过页面左上角的芯片选择下拉菜单选择芯片系列，查看对应的硬件设计指南。

      <img src="docs/_static/choose-chip-target-cn.png" alt="按芯片系列查看" width="400">
...
- 智能文档 AI 助手（新增！）
    ...
    - **每条回答均附有来源链接**，便于您进一步查阅与验证。
      ...
      <img src="docs/_static/chatbot-cn.png" alt="智能助手" width="400">
