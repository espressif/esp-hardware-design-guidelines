<!-- Merge Request Template for Language Updates to Single Chip -->

## MR Description <!-- Mandatory -->
_Please describe the language changes made to the documentation of the specified chip. Highlight the scope of the changes and ideally, list the specific sections that are affected. For example_
- This MR is to update the word "pad" to "pin".
- Affected sections:
...
- Follow the conventions documented in GitLab Wiki -> Conventions -> Release Note Conventions. Example:
  - [ESP32] Improved readability with updated typography
