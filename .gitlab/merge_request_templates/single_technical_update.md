<!-- Merge Request Template for Technical Updates to Single Chip -->

## MR Description <!-- Mandatory -->
_Please provide a detailed description of the technical updates being made to the specified chip. Highlight the scope of the changes and ideally, list the specific sections that are affected. For example:_
...
- Follow the conventions documented in GitLab Wiki -> Conventions -> Release Note Conventions. Example:
  - [ESP32] Updated Strapping pin timing
